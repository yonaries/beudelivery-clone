...
Widget similarFoods(context) {
  final similarFoodList =
      Provider.of<SimilarFoodsController>(context).similarFoodList;
  final isLoaded = Provider.of<SimilarFoodsController>(context).isLoaded;
                              ...
                              child: ClipRRect(
                                ...
                                child: Material(
                                  child: InkWell(
                                    ...
                                    child: Ink.image(
                                      fit: BoxFit.cover,
                                      image: AssetImage(similarFoodList[index]
                                          .image
                                          .toString()),
                                    ),
                                  ),
